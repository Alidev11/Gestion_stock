...
<body>
    ...
    ?>
    <form class="search" method="POST" action="listFournisseur.php">
        <input class="input-search" type="text" name="search" id="search">
        <button type="submit" name="submit"><i class="fas fa-search" ></i></button>
    </form>
        <table class="tableau">
            <caption class="caption">Fournisseurs</caption>
                <thead>
                    <tr>
                        <th>Reference</th>
                        <th>Nom</th>
                ...
                <tbody>
                    <?php  foreach($res as $f){ $a=10; ?>
                        <tr class="row">
                            <td><?php echo "$f->fournisseurId"  ?></td>
                            <td><?php echo "$f->fournisseurNom" ?></td>
                            <td><?php echo "$f->fournisseurTel" ?></td>
                            <td><?php echo "$f->fournisseurEmail" ?></td>
                            <td><?php echo "$f->fournisseurAdr" ?></td>
                            <?php echo "<td><a href=\"deleteFournisseur.php?id=$f->fournisseurId\"><i class=\"fas fa-trash-alt\"></i></a></td>" ; ?>
        ...
        <div class="popup">
            <div class="upHeader">
                <div class="upTitle">Modifier un fournisseur</div>
                <button class="upClose">&times;</button>
            </div>
            <form class="update_form" action="updateFournisseur.php" method="POST">
                    <!-- <i class="fab fa-product-hunt"></i> -->
                    <label for="ref">Reference du fournisseur à modifier:</label>
