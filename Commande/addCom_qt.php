...
<head>
    ...
    <title>Application de gestion de stock | Quantite du commande</title>
</head>
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $com->setProduit($_POST['refP']); 
            $com->setproduitQt($_POST['qt']);
            $com->add1();
    ...
    <div class="container1">
        <div class="nav">
            ...
            <form class="search" method="GET" action="addCom_qt2.php">
        ...
        <div class="login">
            ...
            <div class="form">
                ...
                <form action="addCom_qt.php" method="POST">
