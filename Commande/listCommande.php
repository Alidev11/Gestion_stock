...
<body>
    ...
    ?>
        <table class="tableau">
            <caption class="caption">Commandes</caption>
                <thead>
                    <tr>
                        <th>Reference</th>
                        <th>La date</th>
                ...
                <tbody>
                    <?php  foreach($res as $p){ ?>
                        <tr class="row">
                            <td><?php echo "$p->commandeId" ?></td>
                            <td><?php echo "$p->commandeDate" ?></td>
                            <td><?php echo "$p->commandeClient_num" ?></td>
                            <td><?php echo "$p->comProduit_id" ?></td>
                            <td><?php echo "$p->comProduit_qt" ?></td>
                            <?php echo "<td><a href=\"pdf.php?id=$p->commandeId\"><i class=\"fas fa-print\"></i></a></td>" ; ?>
                    <?php } ?>
                        </tr>
